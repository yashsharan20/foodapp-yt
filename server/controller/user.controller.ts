...
import { sendPasswordResetEmail, sendResetSuccessEmail, sendVerificationEmail, sendWelecomeEmail } from "../mailtrap/email";
...
export const verifyEmail = async(req:Request,res:Response)=>{
    try {
        ...
        await sendWelecomeEmail(user.email,user.fullname)
        return res.status(200).json({
            success:true,
